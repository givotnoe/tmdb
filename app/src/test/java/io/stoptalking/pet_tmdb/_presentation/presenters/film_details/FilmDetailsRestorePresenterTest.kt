...
import io.stoptalking.pet_tmdb.film_details.presenters.FilmDetailsRestorePresenter
...
class FilmDetailsRestorePresenterTest {
    ...
    fun testCorrectUuid() {
        ...
        given(useCase.restoreDetails(3))
    ...
    fun testDefaultUuid() {
        ...
        given(useCase.restoreDetails(DEFAULT_INT))
    ...
    fun testIoError() {
        ...
        //then
        then(view).should().onNetworkIOError(FILM_DETAILS_RESTORE)
    }
    ...
    fun testServerError() {
        ...
        //then
        then(view).should().onNetworkServerError(FILM_DETAILS_RESTORE, httpException.message)
    }
    ...
    fun testUnknownError() {
        ...
        //then
        then(view).should().onUnknownError(FILM_DETAILS_RESTORE)
    }
}